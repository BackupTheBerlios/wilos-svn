...
public class GuidanceDaoTest {
	...
	public GuidanceDaoTest() {
		// Get the ActivityDao Singleton for managing Activity data
		this.guidanceDAO = (GuidanceDao) TestConfiguration.getInstance()
				.getApplicationContext().getBean("GuidanceDao");
	...
	public void setUp() {
		...
		// TODO modifier pour etre a jour pour la nouvelle conception de
		// guidance
		/*
	...
	public void testDeleteGuidance() {
		...
		// Test the method deleteGuideline with an guideline unexisting into the
		// db.
