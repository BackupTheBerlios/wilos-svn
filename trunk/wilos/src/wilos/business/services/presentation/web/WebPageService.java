...
public class WebPageService {
	...
	/**
	 * Method designed to change main page content of the wilos web application.
	 * 
	 * @param _pageUrl
	 *            The url of the page to display in the main part of the web
	 *            application.
	 */
	...
	private MenuBean getMenuBean(){
		...
		MenuBean menuBean = (MenuBean) facesContext.getApplication()
				.createValueBinding("#{menu}").getValue(facesContext);
		return menuBean;
	}
}
