...
public class WizardServices {
	...
	@WebMethod
	public String getParticipant(@WebParam(name = "login")
	...
	String password) throws Exception {
		...
		wu = assistantService.getParticipantTO(getAuthentifiedParticipant(
	...
	@WebMethod
	public byte[] getGuidanceAttachment(@WebParam(name = "login")
	String login, @WebParam(name = "password")
	String password, @WebParam(name = "idGuidance")
	String idGuidance) throws Exception {
		String filePath = "";
		Participant wu = new Participant();
	...
	@WebMethod
	public void startConcreteTaskDescriptor(@WebParam(name = "login")
	String login, @WebParam(name = "password")
	...
	@WebMethod
	public void suspendConcreteTaskDescriptor(@WebParam(name = "login")
	String login, @WebParam(name = "password")
	String password, @WebParam(name = "id")
	String id) throws Exception {
	...
	@WebMethod
	public void resumeConcreteTaskDescriptor(@WebParam(name = "login")
	String login, @WebParam(name = "password")
	String password, @WebParam(name = "id")
	String id) throws Exception {
	...
	@WebMethod
	public void stopConcreteTaskDescriptor(@WebParam(name = "login")
	String login, @WebParam(name = "password")
	String password, @WebParam(name = "id")
	String id) throws Exception {
	...
	@WebMethod
	public void setAccomplishedTimeByTask(@WebParam(name = "login")
	String login, @WebParam(name = "password")
	String password, @WebParam(name = "taskGuid")
	String taskGuid, @WebParam(name = "newTime")
	float newTime) throws Exception {
	...
	@WebMethod
	public void setRemainingTimeByTask(@WebParam(name = "login")
	String login, @WebParam(name = "password")
	String password, @WebParam(name = "taskGuid")
	String taskGuid, @WebParam(name = "newTime")
	float newTime) throws Exception {
	...
	private Participant getAuthentifiedParticipant(String login, String password)
			throws Exception {
