...
public class ActivityDaoTest {
	...
	public void setUp() {
		...
		this.activityDao = (ActivityDao) TestConfiguration.getInstance()
				.getApplicationContext().getBean("ActivityDao");
	...
	public void testGetActivity() {
		...
		assertEquals("HasMultipleOccurences", activityTmp
				.getHasMultipleOccurrences(), HAS_MULTIPLE_OCCURENCES);
		assertEquals("IsEvenDriven", activityTmp.getIsEvenDriven(),
				IS_EVEN_DRIVEN);
		...
		assertEquals("IsRepeatale", activityTmp.getIsRepeatable(),
				IS_REPEATABLE);
