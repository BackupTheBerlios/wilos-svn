 ...
 *
 */
public class IterationDaoTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		this.iterationDao = (IterationDao) TestConfiguration.getInstance().getApplicationContext().getBean("IterationDao") ;
	...
	/*
	 * Test method for {@link woops2.hibernate.iteration.IterationDao#saveOrUpdateProcess(woops2.model.process.Process)}.
	 */
	...
	public final void testGetAllIterations() {
		...
		// Look if this iteration is also into the database and look if the size of the set is >= 1.
	...
	public final void testDeleteIteration() {
		...
		// Test the method deleteIteration with an iteration existing into the db.
		this.iterationDao.deleteIteration(this.iteration) ;
		...
		// Test the method deleteIteration with an iteration unexisting into the db.
