...
public class ConcreteActivityDaoTest  extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		this.concreteactivityDao = (ConcreteActivityDao) TestConfiguration.getInstance().getApplicationContext().getBean("ConcreteActivityDao") ;
	...
	/*
	 * Test method for {@link woops2.hibernate.activity.ConcreteActivityDao#getAllConcreteActivities()}.
	 * 
	 */
	public void testGetAllConcreteActivities() {
		...
		// Look if this concrete activity is also into the database and look if the size of the set is >= 1.
	...
	/*
	 * Test method for {@link woops2.hibernate.activity.ConcreteActivityDao#getConcreteActivity()}.
	 * 
	 */
	...
	/*
	 * Test method for {@link woops2.hibernate.activity.ConcreteActivityDao#deleteConcreteActivity()}.
	 * 
	 */
	public void testDeleteConcreteActivity() {
		...
		// Test the method deleteConcreteActivity with an activity existing into the db.
		this.concreteactivityDao.deleteConcreteActivity(this.concreteactivity) ;
		...
		// Test the method deleteConcreteActivity with an activity unexisting into the db.
